...
for ln in eles:
	if ln.LineStyle.Name == "ME-WALL":
		me_walls.append(ln)
print(me_walls[0].GeometryCurve.GetEndPoint(0))

ref1 = me_walls[0].GeometryCurve.GetEndPoint(0)
ref2 = me_walls[1].GeometryCurve.GetEndPoint(1)
t.Start("Ref")
doc.Create.NewReferencePlane(ref1, ref2, XYZ(0,0,-1), doc.ActiveView)
t.Commit()
# t.Start("Ref")
# doc.Create.NewReferencePlane(XYZ(-22.6588644220049, 11.0704374588559, 0), XYZ(-47.3671977553383, 11.0704374588559, 0), XYZ(0,0,-1), doc.ActiveView)
# t.Commit()